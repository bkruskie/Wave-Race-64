...
void func_801EBFE4(void) {
    ...
    func_801E6A4C(0, 0);
    gCameraPerspective[0].viewMode = 1;
    if (D_800DA9AC != 0) {
        D_800DA9D0 = 0;
    }
    func_800C21F4(0xA, 0);
...
void func_801EE91C(MtxF_t arg0, f32 x, f32 y, f32 z) {
    arg0[0][0] = x;
    arg0[1][1] = y;
    arg0[2][2] = z;
    arg0[1][0] = 0.0f;
...
void func_801EE97C(Mtx* arg0, f32 arg1, f32 arg2, f32 arg3) {
    MtxF mtx;

    func_801EE91C((float(*)[4]) &mtx, arg1, arg2, arg3);
