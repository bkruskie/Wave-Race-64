...
extern Unk_801C43F8_block D_801C43F8[];
...
void func_800895A0(f64* arg0, f64* arg1, f32 arg2, f32 arg3) {
    ...
    if (1000.0 <= temp_f0) {
        ...
        *arg0 = (arg2 * 1000.0) + sp0;
        *arg1 = (arg3 * 1000.0) + temp;
    }
}
...
void func_80089C08(void) {
    ...
    func_8008962C(2000.0f, 157.5f, 70.0f, &D_801C4338);
    func_8008962C(2000.0f, 180.0f, 80.0f, &D_801C4350);
    func_8008962C(2000.0f, 202.5f, 30.0f, &D_801C4368);
    func_8008962C(2000.0f, 225.0f, 50.0f, &D_801C4380);
    func_8008962C(2000.0f, 257.5f, 80.0f, &D_801C4398);
    func_8008962C(2000.0f, 270.0f, 80.0f, &D_801C43B0);
    func_8008962C(2000.0f, 292.5f, 20.0f, &D_801C43C8);
    func_8008962C(2000.0f, 315.0f, 30.0f, &D_801C43E0);
}
...
void func_8008A0E0(void) {
    s32 i;

    for (i = 0; i < 4; i++) {
        D_801C4278[i].unk14 = 0.0f;
        D_801C4278[i].unk0 = 0.0f;
        D_801C4278[i].unk4 = 0.0f;
        D_801C4278[i].unk8 = 0.0f;
        D_801C4278[i].unkC = 0.0f;
        D_801C4278[i].unk10 = 0.0f;
    }
}

Gfx* func_8008BD2C(Gfx* arg0) {
    s32 i;
...
void func_8008D454(void) {
    ...
    for (i = 0; i < 4; i++) {
        D_801C4278[i + 16].unk14 = 0.0f;
        D_801C4278[i + 16].unk0 = 0.0f;
        D_801C4278[i + 16].unk4 = 0.0f;
        D_801C4278[i + 16].unk8 = 0.0f;
        D_801C4278[i + 16].unkC = 0.0f;
        D_801C4278[i + 16].unk10 = 0.0f;
    }
}

void func_8008D94C(void) {
    s32 i;

    for (i = 0; i < 4; i++) {
        D_801C4278[i + 20].unk14 = 0.0f;
        D_801C4278[i + 20].unk0 = 0.0f;
        D_801C4278[i + 20].unk4 = 0.0f;
        D_801C4278[i + 20].unk8 = 0.0f;
        D_801C4278[i + 20].unkC = 0.0f;
        D_801C4278[i + 20].unk10 = 0.0f;
    }
}
...
void func_8008DFD0(void) {
    ...
    for (i = 0; i < 4; i++) {
        D_801C4278[i + 24].unk14 = 0.0f;
        D_801C4278[i + 24].unk0 = 0.0f;
        D_801C4278[i + 24].unk4 = 0.0f;
        D_801C4278[i + 24].unk8 = 0.0f;
        D_801C4278[i + 24].unkC = 0.0f;
        D_801C4278[i + 24].unk10 = 0.0f;
    }
}
...
void func_8008E4B0(void) {
    ...
    for (i = 0; i < 4; i++) {
        D_801C4278[i + 28].unk14 = 0.0f;
        D_801C4278[i + 28].unk0 = 0.0f;
        D_801C4278[i + 28].unk4 = 0.0f;
        D_801C4278[i + 28].unk8 = 0.0f;
        D_801C4278[i + 28].unkC = 0.0f;
        D_801C4278[i + 28].unk10 = 0.0f;
    }
}
...
void func_8008E794(void) {
    ...
    for (i = 0; i < 4; i++) {
        D_801C4278[i + 32].unk14 = 0.0f;
        D_801C4278[i + 32].unk0 = 0.0f;
        D_801C4278[i + 32].unk4 = 0.0f;
        D_801C4278[i + 32].unk8 = 0.0f;
        D_801C4278[i + 32].unkC = 0.0f;
        D_801C4278[i + 32].unk10 = 0.0f;
    }
}
...
Gfx* func_8008FB74(Gfx* arg0) {
    ...
    for (i = 0; i < 4; i++) {
        D_801C4278[i + 36].unk14 = 0.0f;
        D_801C4278[i + 36].unk0 = 0.0f;
        D_801C4278[i + 36].unk4 = 0.0f;
        D_801C4278[i + 36].unk8 = 0.0f;
        D_801C4278[i + 36].unkC = 0.0f;
        D_801C4278[i + 36].unk10 = 0.0f;
    }
    return arg0;
}
...
void func_800916B4(Gfx* gdl) {
    func_80091DBC(gdl);
}

Gfx* func_80091CD8(Gfx* gdl) {
    gSPNumLights(gdl++, NUMLIGHTS_1);
    gSPLight(gdl++, (Light*) ((u32) &D_801C43F8[D_8011F8E0] + D_800DAB2C * 0x18 + 0x35D8), LIGHT_1);
    gSPLight(gdl++, (Light*) ((u32) &D_801C43F8[D_8011F8E0] + D_800DAB2C * 0x18 + 0x35D0), LIGHT_2);
    return gdl;
}
...
GLOBAL_ASM("asm/us/rev1/nonmatchings/game/code_43DA0/func_80091DBC.s")
