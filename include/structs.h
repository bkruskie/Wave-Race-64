...
struct UnkStruct_801C3C50 {
    ...
    /* 0x0B52 */ s8 unkB52;
    /* 0x0B53 */ u8 unkB53;
    /* 0x0B54 */ char padB54[0x10];
    /* 0x0B64 */ s32 unkB64;
    /* 0x0B68 */ s32 unkB68;
    /* 0x0B6C */ char padB6C[0x24];
    /* 0x0B90 */ f32 unkB90;
...
typedef struct UnkStruct_801C2C24 {
    ...
    /* 0x19C */ s32 unk19C;
    /* 0x1A0 */ char pad1A0[0x124];
    /* 0x2C4 */ s32 unk2C4;
    /* 0x2C8 */ char pad2C8[0x24];
    /* 0x2EC */ s32 unk2EC;
    /* 0x2F0 */ char pad2F0[4];
    /* 0x2F4 */ s32 unk2F4;
    /* 0x2F8 */ char pad2F8[0x34];
    /* 0x32C */ f32 unk32C;
...
typedef struct UnkStruct_80192690 {
    ...
    /* 0x160C */ f32 unk160C;                       /* inferred */
    /* 0x1610 */ f32 unk1610;                       /* inferred */
    /* 0x1614 */ f32 unk1614;                       /* inferred */
    /* 0x1618 */ f32 unk1618;
    /* 0x161C */ f32 unk161C;
    /* 0x1620 */ f32 unk1620;
    /* 0x1624 */ char pad1624[0x30];                /* maybe part of unk1620[0xD]? */
    /* 0x1654 */ f32 unk1654;                       /* inferred */
    /* 0x1658 */ f32 unk1658;                       /* inferred */
    /* 0x165C */ f32 unk165C;                       /* inferred */
